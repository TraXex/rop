...
?>
    <div class="sos_div content-div">
        ...
        <div class="info">
            ...
            <div class="content">
                 <h4><?php echo $this->Html->link($post['Post']['topic'],array('controller'=>'cookings','action'=>'view_news',$post['Post']['id'])); ?></h4>
    ...
    $i++;
                ...
                <?php echo $this->Html->link('View more comments',array('controller'=>'cookings','action'=>'view_news',$post['Post']['id'])); ?>
            </div>
