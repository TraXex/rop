...
?>
    <div class="sos_div content-div">
        ...
        <div class="info">
            ...
            <div class="content">
                <h4><?php echo $this->Html->link($post['Post']['topic'],array('controller'=>'educations','action'=>'view_pink_me_up',$post['Post']['id']), array('escape' => false)); ?></h4>
    ...
    $i++;
                ...
                <?php echo $this->Html->link('View more replies',array('controller'=>'educations','action'=>'view_pink_me_up',$post['Post']['id'])); ?>
            </div>
