...
?>
    <div class="sos_div content-div">
        ...
        <div class="title">
            ...
            <?php // echo $this->Html->image("drop-down.png", array("alt" => "drop", 'url' => array('controller' => 'natures', 'action' => 'index'), array('escape' => false))); ?>
        ...
        <div class="info">
            ...
            <div class="content">
                <h4><?php echo $this->Html->link($post['Post']['topic'],array('controller'=>'natures','action'=>'view_pink_me_up',$post['Post']['id'])); ?></h4>
    ...
    $i++;
                ...
                <?php echo $this->Html->link('View more replies',array('controller'=>'natures','action'=>'view_pink_me_up',$post['Post']['id'])); ?>
            </div>
