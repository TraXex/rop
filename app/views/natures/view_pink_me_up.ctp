...
<div class="widget_804">
                    ...
                    <div class="action-list">
                        <ul>
                            ...
                            if($post['PostDetail']['type']=='pink up'){
                               ...
                               echo $this->Html->link('Edit',array('controller'=>'natures','action'=>'edit_pink_me_up',$post['Post']['id']));
                            
                            }
                                ?></li>
                            <li><?php echo $this->Html->link('Delete',array('controller'=>'natures','action'=>'delete',$post['Post']['id'])); ?></li>
            ...
            <div class="info">
                <div class="heading diff_heading">
                    ...
                    <div class="inner-heading">
                        ...
                        <div class="right">
                             <span><?php 
                        $timeTook=$this->Time->timeAgoInWords( $reply['Reply']['created']);
                        $roundOff= strpos($timeTook,',');
                        if($roundOff){
                            echo substr( $timeTook,0,strpos($timeTook,','))." ago";
                        }else{
    ...
    <div class="add-comment">
        ...
        echo $form->create('Reply', array('url' => array('controller' => 'natures', 'action' => 'add_pink_me_up_reply')));
