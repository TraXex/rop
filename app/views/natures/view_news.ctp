        ...
        <div class="title">
            ...
            ?>
                ...
                if ($post['PostDetail']['type'] == 'discussion') {
                    ...
                    echo $this->Html->link('Edit', array('controller' => 'natures', 'action' => 'edit_discussion', $post['Post']['id']));
                } else {
                    echo $this->Html->link('Edit', array('controller' => 'natures', 'action' => 'edit_news', $post['Post']['id']));
                }
                ?></li>
