...
?>
    <div class="sos_div content-div">
        ...
        <div class="info">
            ...
            <div class="content">
                <h4><?php echo $this->Html->link($post['Post']['topic'],array('controller'=>'natures','action'=>'view_news',$post['Post']['id'])); ?></h4>
                <p><?php 
    ...
    $i++;
                ...
                <?php echo $this->Html->link('View more comments',array('controller'=>'natures','action'=>'view_news',$post['Post']['id'])); ?>
            </div>
