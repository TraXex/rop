        ...
        <div class="title">
            ...
            ?>
                ...
                if ($post['PostDetail']['type'] == 'discussion') {
                    ...
                    echo $this->Html->link('Edit', array('controller' => 'seniors', 'action' => 'edit_discussion', $post['Post']['id']));
                } else {
                    echo $this->Html->link('Edit', array('controller' => 'seniors', 'action' => 'edit_news', $post['Post']['id']));
                }
                ?></li>
                        <li><?php echo $this->Html->link('Delete',array('controller'=>'seniors','action'=>'delete',$post['Post']['id'])); ?></li>
