...
?>
    <div class="sos_div content-div">
        ...
        <div class="info">
           ...
           <div class="content">
                <h4><?php echo $this->Html->link($post['Post']['topic'],array('controller'=>'gossips','action'=>'view_advice',$post['Post']['id']), array('escape' => false)); ?></h4>
    ...
    $i++;
                ...
                <?php echo $this->Html->link('View more comments',array('controller'=>'gossips','action'=>'view_advice',$post['Post']['id'])); ?>
            </div>
