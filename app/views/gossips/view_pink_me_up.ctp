...
<div class="widget_804">
                    ...
                    <div class="action-list">
                        <ul>
                            ...
                            if($post['PostDetail']['type']=='pink up'){
                               ...
                               echo $this->Html->link('Edit',array('controller'=>'gossips','action'=>'edit_pink_me_up',$post['Post']['id']));
                            
                            }
                                ?></li>
                            <li><?php echo $this->Html->link('Delete',array('controller'=>'gossips','action'=>'delete',$post['Post']['id'])); ?></li>
    ...
    <div class="add-comment">
        ...
        echo $form->create('Reply', array('url' => array('controller' => 'gossips', 'action' => 'add_pink_me_up_reply')));
