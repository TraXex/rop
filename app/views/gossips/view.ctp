                    ...
                    <div class="action-list">
                        <ul>
                            ...
                            if($post['PostDetail']['type']=='discussion'){
                               ...
                               echo $this->Html->link('Edit',array('controller'=>'gossips','action'=>'edit_discussion',$post['Post']['id']));
                            
                            }else{
                                echo $this->Html->link('Edit',array('controller'=>'gossips','action'=>'edit_news',$post['Post']['id']));
                            }
                                ?></li>
